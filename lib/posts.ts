...
export const sortedPosts: Record<string, Post[] | undefined> = {};
...
for (let i = 0; i < posts.length; i++) {
  ...
  // TODO: This function ensures this array exists, but TS doesn't see that
	(sortedPosts[category] as Post[]).push(post);
}
