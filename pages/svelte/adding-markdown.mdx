...
<Head>
  <title>chrsjxn.io - Building a blog with Svelte: Adding Markdown</title>
  <link
    rel="icon"
...
![Comparison of this post rendered in Svelte and on dev.to](/images/markdownComparison.png)
