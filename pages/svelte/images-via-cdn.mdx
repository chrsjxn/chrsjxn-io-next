...
import polaroidComponentDemo from '@/public/images/PolaroidComponentDemo.png'

<Head>
  <title>chrsjxn.io - Building a blog with Svelte: Fetching images via CDN</title>
  <link
    rel="icon"
...
<Image
  src={polaroidComponentDemo}
  alt="Polaroid component demo. Four polaroid images stack on top of each other, slightly haphazardly. One shows SF during the wildfires, when the sky was orange and dark. One shows the author, looking at his laptop and thinking. And the other two are close ups of birds, one seagull and one raven."
  width="800"
  layout="responsive"
/>
