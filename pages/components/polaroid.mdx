...
import raven from '@/public/images/raven.jpg'
import gull from '@/public/images/gull.jpg'
...
<div className={styles.demoContainer}>
	<div>
		<Polaroid src={raven} alt="Raven" style="drama">Yellowstone 08/31/2015</Polaroid>
	</div>
	<div style={{transform: 'rotate(1deg)'}}>
		<Polaroid src={gull} alt="Gull" style="vignette">Marin 03/26/2016</Polaroid>
	</div>
	<div style={{transform: 'rotate(-2deg)'}}>
		<Polaroid src={profile} alt="Developer self portrait" style="drama">
			SF 11/01/2020
		</Polaroid>
	</div>
